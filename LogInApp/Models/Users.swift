...
let user = User(userName: "User",
                ...
                person: Person(
                    ...
                    surName: "Азимов",
                    age: 72,
                    company: "Amazing Stories",
                    biography: "А́йзек Ази́мов — американский писатель-фантаст, популяризатор науки, биохимик. Автор около 500 произведений, в основном художественных (прежде всего в жанре научной фантастики, но также и в других жанрах: фэнтези, детектив, юмор) и научно-популярных (в самых разных областях — от астрономии и генетики до истории и литературоведения). Многократный лауреат премий «Хьюго» и «Небьюла».",
                    books: Book(
                        title: "'Я, робот'",
                        year: 1950,
